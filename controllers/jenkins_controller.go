...
// +kubebuilder:rbac:groups=apps,resources=deployments/rollback,verbs=create;delete;deletecollection;patch;update
// +kubebuilder:rbac:groups=apps,resources=deployments/scale,verbs=create;delete;deletecollection;patch;update;get;list;watch
...
// +kubebuilder:rbac:groups=apps,resources=replicasets/scale,verbs=create;delete;deletecollection;patch;update;get;list;watch
// +kubebuilder:rbac:groups=apps,resources=replicasets/status,verbs=get;list;watch
// +kubebuilder:rbac:groups=apps,resources=statefulsets,verbs=get;list;watch;create;update;patch;delete;deletecollection
// +kubebuilder:rbac:groups=apps,resources=statefulsets/scale,verbs=create;delete;deletecollection;patch;update;get;list;watch
// +kubebuilder:rbac:groups=apps,resources=statefulsets/status,verbs=get;list;watch
// +kubebuilder:rbac:groups=apps.openshift.io,resources=deploymentconfigrollbacks,verbs=create
// +kubebuilder:rbac:groups=apps.openshift.io,resources=deploymentconfigs,verbs=create;delete;deletecollection;patch;update;get;list;watch
// +kubebuilder:rbac:groups=apps.openshift.io,resources=deploymentconfigs/instantiate,verbs=create
// +kubebuilder:rbac:groups=apps.openshift.io,resources=deploymentconfigs/log,verbs=get;list;watch
// +kubebuilder:rbac:groups=apps.openshift.io,resources=deploymentconfigs/rollback,verbs=create
// +kubebuilder:rbac:groups=apps.openshift.io,resources=deploymentconfigs/scale,verbs=create;delete;deletecollection;patch;update;get;list;watch
// +kubebuilder:rbac:groups=apps.openshift.io,resources=deploymentconfigs/status,verbs=get;list;watch
// +kubebuilder:rbac:groups=autoscaling,resources=horizontalpodautoscalers,verbs=create;delete;deletecollection;patch;update;get;list;watch
...
// +kubebuilder:rbac:groups=batch,resources=cronjobs/status,verbs=get;list;watch
...
// +kubebuilder:rbac:groups=core,resources=pods/exec,verbs=get;list;watch;create;update;patch;delete;deletecollection
// +kubebuilder:rbac:groups=core,resources=pods/attach,verbs=get;list;watch;create;update;patch;delete;deletecollection
// +kubebuilder:rbac:groups=core,resources=pods/proxy,verbs=get;list;watch;create;update;patch;delete;deletecollection
// +kubebuilder:rbac:groups=core,resources=pods/portforward,verbs=get;list;watch;create;update;patch;delete;deletecollection
// +kubebuilder:rbac:groups=core,resources=pods,verbs=get;list;watch;deletecollection
// +kubebuilder:rbac:groups=core,resources=serviceaccounts,verbs=get;list;watch;create;update;patch;delete;deletecollection;impersonate
// +kubebuilder:rbac:groups=core,resources=services,verbs=get;list;watch;create;update;patch;delete;deletecollection
// +kubebuilder:rbac:groups=core,resources=services/proxy,verbs=get;list;watch;create;update;patch;delete;deletecollection
...
// +kubebuilder:rbac:groups=core,resources=routes,verbs=get;list;watch;create;update;patch;delete;deletecollection
// +kubebuilder:rbac:groups=core,resources=routes/custom-host,verbs=create
// +kubebuilder:rbac:groups=route.openshift.io,resources=routes/status,verbs=get;list;watch
// +kubebuilder:rbac:groups=template.openshift.io,resources=processedtemplates,verbs=get;list;watch;create;update;patch;delete;deletecollection
// +kubebuilder:rbac:groups=template.openshift.io,resources=templateconfigs,verbs=get;list;watch;create;update;patch;delete;deletecollection
// +kubebuilder:rbac:groups=template.openshift.io,resources=templateinstances,verbs=get;list;watch;create;update;patch;delete;deletecollection
...
// +kubebuilder:rbac:groups=build.openshift.io,resources=builds,verbs=get;list;watch;create;update;patch;delete;deletecollection
// +kubebuilder:rbac:groups=build.openshift.io,resources=builds/clone,verbs=create
// +kubebuilder:rbac:groups=build.openshift.io,resources=builds/details,verbs=update
// +kubebuilder:rbac:groups=build.openshift.io,resources=builds/log,verbs=get;list;watch
// +kubebuilder:rbac:groups=build.openshift.io,resources=jenkins,verbs=edit;view
// +kubebuilder:rbac:groups=build.openshift.io,resources=buildconfigs,verbs=get;list;watch;create;update;patch;delete;deletecollection
// +kubebuilder:rbac:groups=build.openshift.io,resources=buildconfigs/instantiate,verbs=create
// +kubebuilder:rbac:groups=build.openshift.io,resources=buildconfigs/instantiatebinary,verbs=create
// +kubebuilder:rbac:groups=build.openshift.io,resources=buildconfigs/webhooks,verbs=get;list;watch;update;patch;delete;deletecollection
// +kubebuilder:rbac:groups=build.openshift.io,resources=buildlogs,verbs=get;list;watch;update;patch;create;delete;deletecollection
// +kubebuilder:rbac:groups=image.openshift.io,resources=imagestreams,verbs=get;list;watch;create;update;patch;delete;deletecollection
// +kubebuilder:rbac:groups=image.openshift.io,resources=imagestreamimages,verbs=get;list;watch;update;patch;create;delete;deletecollection
// +kubebuilder:rbac:groups=image.openshift.io,resources=imagestreamimports,verbs=create
// +kubebuilder:rbac:groups=image.openshift.io,resources=imagestreammappings,verbs=get;list;watch;update;patch;create;delete;deletecollection
// +kubebuilder:rbac:groups=image.openshift.io,resources=imagestreams/layers,verbs=update
// +kubebuilder:rbac:groups=image.openshift.io,resources=imagestreams/secrets,verbs=get;list;watch;update;patch;create;delete;deletecollection
// +kubebuilder:rbac:groups=image.openshift.io,resources=imagestreams/status,verbs=get;list;watch
// +kubebuilder:rbac:groups=image.openshift.io,resources=imagestreamtags,verbs=get;list;watch;update;patch;create;delete;deletecollection
// +kubebuilder:rbac:groups=image.openshift.io,resources=imagetags,verbs=get;list;watch;update;patch;create;delete;deletecollection
// +kubebuilder:rbac:groups=metrics.k8s.io,resources=nodes,verbs=get;list;watch
// +kubebuilder:rbac:groups=metrics.k8s.io,resources=pods,verbs=get;list;watch
// +kubebuilder:rbac:groups=networking.k8s.io,resources=ingresses,verbs=get;list;watch;update;patch;create;delete;deletecollection
// +kubebuilder:rbac:groups=networking.k8s.io,resources=ingresses/status,verbs=get;list;watch
// +kubebuilder:rbac:groups=networking.k8s.io,resources=networkpolicies,verbs=get;list;watch;update;patch;create;delete;deletecollection
// +kubebuilder:rbac:groups=operators.coreos.com,resources=catalogsources,verbs=get;list;watch;delete
// +kubebuilder:rbac:groups=operators.coreos.com,resources=clusterserviceversions,verbs=get;list;watch;delete
// +kubebuilder:rbac:groups=operators.coreos.com,resources=installplans,verbs=get;list;watch;delete
// +kubebuilder:rbac:groups=operators.coreos.com,resources=operatorgroups,verbs=get;list;watch;delete
// +kubebuilder:rbac:groups=operators.coreos.com,resources=subscriptions,verbs=get;list;watch;update;patch;create;delete
// +kubebuilder:rbac:groups=packages.operators.coreos.com,resources=packagemanifests,verbs=get;list;watch;update;patch;create;delete
// +kubebuilder:rbac:groups=packages.operators.coreos.com,resources=packagemanifests/icon,verbs=get;list;watch
// +kubebuilder:rbac:groups=quota.openshift.io,resources=appliedclusterresourcequotas,verbs=get;list;watch
// +kubebuilder:rbac:groups=policy,resources=poddisruptionbudgets,verbs=get;list;watch;update;patch;create;delete;deletecollection
// +kubebuilder:rbac:groups=policy,resources=poddisruptionbudgets/status,verbs=get;list;watch
...
// +kubebuilder:rbac:groups=apps,resources=daemonsets,verbs=create;delete;deletecollection;patch;update;get;list;watch
// +kubebuilder:rbac:groups=apps,resources=daemonsets/status,verbs=get;list;watch
// +kubebuilder:rbac:groups=extensions,resources=daemonsets,verbs=get;list;watch;create;update;patch;delete;deletecollection
// +kubebuilder:rbac:groups=extensions,resources=daemonsets/status,verbs=get;list;watch
// +kubebuilder:rbac:groups=extensions,resources=deployments,verbs=get;list;watch;create;update;patch;delete;deletecollection
// +kubebuilder:rbac:groups=extensions,resources=deployments/rollback,verbs=create;update;patch;delete;deletecollection
// +kubebuilder:rbac:groups=extensions,resources=deployments/scale,verbs=create;update;patch;delete;deletecollection;get;list;watch
// +kubebuilder:rbac:groups=extensions,resources=deployments/status,verbs=get;list;watch
// +kubebuilder:rbac:groups=extensions,resources=ingresses,verbs=create;update;patch;delete;deletecollection;get;list;watch
// +kubebuilder:rbac:groups=extensions,resources=ingresses/status,verbs=get;list;watch
// +kubebuilder:rbac:groups=extensions,resources=networkpolicies,verbs=create;update;patch;delete;deletecollection;get;list;watch
// +kubebuilder:rbac:groups=extensions,resources=replicasets,verbs=get;list;watch;create;update;patch;delete;deletecollection
// +kubebuilder:rbac:groups=extensions,resources=replicasets/scale,verbs=create;update;patch;delete;deletecollection;get;list;watch
// +kubebuilder:rbac:groups=extensions,resources=replicasets/status,verbs=get;list;watch
// +kubebuilder:rbac:groups=core,resources=replicationcontrollers,verbs=create;update;patch;delete;deletecollection;get;list;watch
// +kubebuilder:rbac:groups=core,resources=replicationcontrollers/scale,verbs=create;update;patch;delete;deletecollection;get;list;watch
// +kubebuilder:rbac:groups=extensions,resources=replicationcontrollers/scale,verbs=create;update;patch;delete;deletecollection;get;list;watch
// +kubebuilder:rbac:groups=core,resources=replicationcontrollers/scale,verbs=create;update;patch;delete;deletecollection;get;list;watch
// +kubebuilder:rbac:groups=core,resources=builds,verbs=get;list;watch;create;update;patch;delete;deletecollection
// +kubebuilder:rbac:groups=core,resources=builds/clone,verbs=create
// +kubebuilder:rbac:groups=core,resources=builds/details,verbs=update
// +kubebuilder:rbac:groups=core,resources=builds/log,verbs=get;list;watch
// +kubebuilder:rbac:groups=core,resources=jenkins,verbs=edit;view
// +kubebuilder:rbac:groups=core,resources=buildconfigs,verbs=get;list;watch;create;update;patch;delete;deletecollection
// +kubebuilder:rbac:groups=core,resources=buildconfigs/instantiate,verbs=create
// +kubebuilder:rbac:groups=core,resources=buildconfigs/instantiatebinary,verbs=create
// +kubebuilder:rbac:groups=core,resources=buildconfigs/webhooks,verbs=get;list;watch;update;patch;delete;deletecollection
// +kubebuilder:rbac:groups=core,resources=buildlogs,verbs=get;list;watch;update;patch;create;delete;deletecollection
// +kubebuilder:rbac:groups=core,resources=buildlogs,verbs=get;list;watch;update;patch;create;delete;deletecollection
// +kubebuilder:rbac:groups=core,resources=deploymentconfigrollbacks,verbs=create
// +kubebuilder:rbac:groups=core,resources=deploymentconfigs,verbs=create;delete;deletecollection;patch;update;get;list;watch
// +kubebuilder:rbac:groups=core,resources=deploymentconfigs/instantiate,verbs=create
// +kubebuilder:rbac:groups=core,resources=deploymentconfigs/log,verbs=get;list;watch
// +kubebuilder:rbac:groups=core,resources=deploymentconfigs/rollback,verbs=create
// +kubebuilder:rbac:groups=core,resources=deploymentconfigs/scale,verbs=create;delete;deletecollection;patch;update;get;list;watch
// +kubebuilder:rbac:groups=core,resources=deploymentconfigs/status,verbs=get;list;watch
// +kubebuilder:rbac:groups=core,resources=imagestreams,verbs=get;list;watch;create;update;patch;delete;deletecollection
// +kubebuilder:rbac:groups=core,resources=imagestreamimages,verbs=get;list;watch;update;patch;create;delete;deletecollection
// +kubebuilder:rbac:groups=core,resources=imagestreamimports,verbs=create
// +kubebuilder:rbac:groups=core,resources=imagestreammappings,verbs=get;list;watch;update;patch;create;delete;deletecollection
// +kubebuilder:rbac:groups=core,resources=imagestreams/layers,verbs=update
// +kubebuilder:rbac:groups=core,resources=imagestreams/secrets,verbs=get;list;watch;update;patch;create;delete;deletecollection
// +kubebuilder:rbac:groups=core,resources=imagestreams/status,verbs=get;list;watch
// +kubebuilder:rbac:groups=core,resources=imagestreamtags,verbs=get;list;watch;update;patch;create;delete;deletecollection
// +kubebuilder:rbac:groups=core,resources=imagetags,verbs=get;list;watch;update;patch;create;delete;deletecollection
// +kubebuilder:rbac:groups=core,resources=processedtemplates,verbs=get;list;watch;create;update;patch;delete;deletecollection
// +kubebuilder:rbac:groups=core,resources=templateconfigs,verbs=get;list;watch;create;update;patch;delete;deletecollection
// +kubebuilder:rbac:groups=core,resources=templateinstances,verbs=get;list;watch;create;update;patch;delete;deletecollection
// +kubebuilder:rbac:groups=core,resources=templates,verbs=get;list;watch;create;update;patch;delete;deletecollection
